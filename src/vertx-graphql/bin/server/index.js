  ...
  installSubscriptionHandlers(app) {
    if (typeof this.subscriptionsPath === 'string') {
      app.route(this.subscriptionsPath).handler((ctx) => {
        ...
        /*
        this.websocket.frameHandler((frame) => {
          console.log('frameHandler', frame.textData())
        });
        */

        /*
        this.websocket.handler((data) => {
          try {
            const dataJSON = JSON.parse(data.toString());
            if (dataJSON.type === 'start') {
        ...
        */
        ...
        console.log('WEBSOCKET', websocket.textHandlerID());
        // console.log('WEBSOCKET', websocket.binaryHandlerID());
        */
      });
    }
