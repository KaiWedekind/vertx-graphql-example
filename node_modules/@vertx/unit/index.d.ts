...
export class Async {
   ...
   * 
   */
  handler(completionHandler: (result: AsyncResult<void>) => void) : void;
...
export class Completion {
   ...
   * 
   */
  handler(completionHandler: (result: AsyncResult<any>) => void) : void;
...
export class EventBusCollector {
  ...
  static create(vertx: Vertx, reporter: (result: TestSuiteReport) => void) : EventBusCollector;
...
export class TestCase {
   ...
   * 
   */
  static create(name: string, testCase: (result: TestContext) => void) : TestCase;
...
export class TestCaseReport {
   ...
   * 
   */
  endHandler(handler: (result: TestResult) => void) : TestCaseReport;
...
export class TestContext {
   ...
   * 
   */
  verify(block: (result: void) => void) : TestContext;
   ...
   * 
   */
  asyncAssertSuccess() : (result: AsyncResult) => void;
   ...
   * 
   */
  asyncAssertSuccess(resultHandler: (result: any) => void) : (result: AsyncResult) => void;
   ...
   * 
   */
  asyncAssertFailure() : (result: AsyncResult) => void;
   ...
   * 
   */
  asyncAssertFailure(causeHandler: (result: Error) => void) : (result: AsyncResult) => void;
   ...
   * 
   */
  exceptionHandler() : (result: Error) => void;
...
export class TestSuite {
   ...
   * 
   */
  before(callback: (result: TestContext) => void) : TestSuite;
   ...
   * 
   */
  beforeEach(callback: (result: TestContext) => void) : TestSuite;
   ...
   * 
   */
  after(callback: (result: TestContext) => void) : TestSuite;
   ...
   * 
   */
  afterEach(callback: (result: TestContext) => void) : TestSuite;
   ...
   * 
   */
  test(name: string, testCase: (result: TestContext) => void) : TestSuite;
   ...
   * 
   */
  test(name: string, repeat: number, testCase: (result: TestContext) => void) : TestSuite;
...
export class TestSuiteReport {
   ...
   * 
   */
  exceptionHandler(handler: (result: Error) => void | null | undefined) : TestSuiteReport;

  handler(handler: (result: TestCaseReport) => void | null | undefined) : TestSuiteReport;

  pause() : TestSuiteReport;

  resume() : TestSuiteReport;

  endHandler(endHandler: (result: void) => void | null | undefined) : TestSuiteReport;
